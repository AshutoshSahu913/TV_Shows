        ...
        tvShowDetailsViewModel.getTVShowDetails(tvShowId).observe(
                this, tvShowDetailsResponse -> {
                    ...
                    if (tvShowDetailsResponse.getTvShowDetails() != null) {
                        ...
                        //this for bottom sheet dialog
                        activityTvshowDetailsBinding.btnEpisodes.setOnClickListener(v -> {
                            if (episodesBottomSheetDialog == null) {
                                episodesBottomSheetDialog = new BottomSheetDialog(TVShowDetails.this);
                            ...
                            if (isTVShowAvailableInWatchlist) {
                                compositeDisposable.add(tvShowDetailsViewModel.removeTVShowFromWatchlist(tvShow)
                                        ...
                                        .subscribe(() -> {
                                            ...
                                            activityTvshowDetailsBinding.imgWatchlist.setImageResource(R.drawable.baseline_star_rate_24);
                                ...
                                TempDataHolder.IS_WATCHLIST_UPDATED=true;
                                            activityTvshowDetailsBinding.imgWatchlist.setImageResource(R.drawable.ic_added);
                                            Toast.makeText(TVShowDetails.this, "Added to Watchlist", Toast.LENGTH_SHORT).show();
                                            compositeDisposable.dispose();
                                        })
                                );
